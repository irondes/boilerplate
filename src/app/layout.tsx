...
export default async function RootLayout({
	...
	return (
		<html lang={process.env.NEXT_PUBLIC_APP_LANG || "pt-BR"}>
			<body
			...
			>
				<StackProvider
					app={stackServerApp}
					lang={
						(process.env.NEXT_PUBLIC_APP_LANG as "pt-BR" | "en-US" | "es-ES") ||
						"pt-BR"
					}
				>
					<StackTheme>
						{user ? (
							<SidebarProvider>
								<AppSidebar />
								<SidebarInset>
									<header className="flex px-1 h-10 shrink-0 items-center gap-2 border-b">
										<div className="flex items-center gap-2">
											<SidebarTrigger />
											<Separator orientation="vertical" className="mr-2 h-4" />
											<Breadcrumbs /> {/* Use o componente dinâmico aqui */}
										</div>
									</header>
